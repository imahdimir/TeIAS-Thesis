...
from mirutil.funcs import print_df_columns_in_dict_type as prntcols
from mirutil.funcs import persian_tools_jdate_from_iso_format_jdate_str as jdstr
...
ipodb_repo = 'https://github.com/imahdimir/d-IPO-Date'
overall_index_repo = 'https://github.com/imahdimir/d-TSE-Overall-Index'
...
if False :
  ...
  ##
  _df['jd'] = _df[
    'JDate'].apply(lambda x : mf.persian_tools_jdate_from_iso_format_jdate_str(x))
